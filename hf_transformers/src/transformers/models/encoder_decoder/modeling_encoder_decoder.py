...
#CHANGED
#実装が大変なので AutoModelをUnilogの場合は利用しない, 上手くいくかは知らない
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        if encoder is None:
            ...
            #CHANGED AutoModelにUnilogは引っかからないので(本来引っかかるようにすべきだが...), 無理やりBertModelを持ってきた
            if kwargs_encoder["config"].is_unilog:
        ...
        if decoder is None:
            ...
            #CHANGED AutoModelにUnilogは引っかからないので(本来引っかかるようにすべきだが...), 無理やりBertLMHeadModelを持ってきた
            if kwargs_decoder["config"].is_unilog:
